...
module.exports = {
    ...
    aliases: ['notworking','stopped','noreply'],
    ...
    execute(message, args) {
        ...
        .addFields(
            { name: '<:rightSort:809165006477459507> Muted / Quarantine', value: '<:blank:809168046052474881> <:rightDoubleArrow:809168332569575427> Check if you have the <@&538362437288853504> / <@&536289928913616906> role. *Wick does not respond to people with the <@&536289928913616906> or <@&538362437288853504> role*' },
            { name: '<:rightSort:809165006477459507> I dont have them on me', value: '<:blank:809168046052474881> <:rightDoubleArrow:809168332569575427> Ask one of your fellow server users to type `w!ping` or any other wick command. If wick responds to them, you most likely have your <@&538362437288853504> / <@&536289928913616906> role on you.' },
