...
module.exports = {
 name: 'bugdeny', // The name of the command
  ...
  if (message.member.roles.cache.some(r => ["Team", "Support", "Moderator","Bug Hunter"].includes(r.name))) {
   ...
   try {
    ...
    const acceptEmbed = new MessageEmbed()
     ...
     .addField("<:rightSort:809165006477459507> Status:", "<:blank:809168046052474881> <:fail:809847979368120470> This bug has been denied!")
