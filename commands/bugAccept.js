...
module.exports = {
 name: 'bugaccept', // The name of the command
 ...
 execute: async function (message, args, Discord) {
  if (message.member.roles.cache.some(r => ["Team", "Support", "Moderator","Bug Hunter"].includes(r.name))) {
   ...
   try {
    const suggestionChannel = message.guild.channels.cache.get("699954781980065813");
    ...
    const acceptEmbed = new MessageEmbed()
     ...
     .addField("<:rightSort:809165006477459507> Status:", "<:blank:809168046052474881> <:check:809847958878552164> This bug has been tested and confirmed")
     .addField(`<:owner:809530582714941520> Staff Answer \`[${message.author.tag}]\``, `<:blank:809168046052474881> ${acceptQuery}`)
    ...
    message.channel.send({
     embed: {
      color: '#36393f',
      description: '<:fail:809847979368120470> That bug report does not exist'
     }
    });
   }
  } else {
