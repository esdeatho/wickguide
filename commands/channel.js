...
module.exports = {
   ...
   // aliases: 's',
    execute(message, args) {
        ...
        .addFields(
            { name: '<:Mute:817089217016496168> Muted', value: '<:blank:809168046052474881> <:rightDoubleArrow:809168332569575427> This means that the user has a certain role that is forced to **send messages** which makes the <@&536289928913616906> (and <@&538362437288853504>) role not work properly. \n<:blank:809168046052474881> <:rightDoubleArrow:809168332569575427> Make sure the @everyone role has **neutral** <:neutral:809847927660216331> stance when it comes to Read Messages and Send Messages. *do the same with any other role.*  ' },
       ...
       .setImage('https://images-ext-1.discordapp.net/external/3fX5Gx5Ir3GVTmMxwjJshDqkQR0vG50T69LyktG0k_Y/https/images.fnaki.gay/channelperms.png?width=1440&height=393')
