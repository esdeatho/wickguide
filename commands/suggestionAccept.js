...
module.exports = {
 name: 'acceptsuggestion', // The name of the command
  ...
  if (message.member.roles.cache.some(r => ["Team", "Support", "Moderator"].includes(r.name))) {
   ...
   try {
    ...
    const acceptEmbed = new MessageEmbed()
     ...
     .addField("<:rightSort:809165006477459507> Status:", "<:blank:809168046052474881> <:check:809847958878552164> This suggestion has been accepted!")
