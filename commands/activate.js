...
module.exports = {
   ...
   // aliases: 's',
    execute(message, args) {
        ...
        .addFields(
            { name: '<:rightSort:809165006477459507> Activate', value: '<:blank:809168046052474881> <:rightDoubleArrow:809168332569575427> Use `*activate Your-Server-ID` in Wick Lounge \n <:blank:809168046052474881> <:blank:809168046052474881> <:rightsmall:809587446182445086> Replace `Your-Server-ID` with your actual server ID' },
