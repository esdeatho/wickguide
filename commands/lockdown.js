...
module.exports = {
   ...
   // aliases: 's',
    execute(message, args) {
        ...
        .addFields(
            { name: '<:danger:809528345981222943> Important', value: '<:blank:809168046052474881> <:rightDoubleArrow:809168332569575427> All your server roles (except @everyone) should **not** have the permission to **Send Messages** and **Read Text Channels** & **See Voice Channels**. If that is your case, you are good. \n <:blank:809168046052474881> <:blank:809168046052474881> <:rightsmall:809587446182445086> If not type `w!tshoot lockdown` to set your **ROLES** permissions right' },
            { name: '<:rightSort:809165006477459507> Types', value: '<:blank:809168046052474881> <:rightDoubleArrow:809168332569575427> **[Channel](https://mobilfan.gitbook.io/wickdocs-wip/v/main/commands/moderation/lockdown#1-channel-c)** `w!ld ?t c` \n <:blank:809168046052474881> <:rightDoubleArrow:809168332569575427> **[All Channels](https://mobilfan.gitbook.io/wickdocs-wip/v/main/commands/moderation/lockdown#2-channels-sc)** `w!ld ?t sc` \n <:blank:809168046052474881> <:rightDoubleArrow:809168332569575427> **[Kick New Members](https://mobilfan.gitbook.io/wickdocs-wip/v/main/commands/moderation/lockdown#3-auto-kick-new-members-k)** `w!ld ?t k` \n <:blank:809168046052474881> <:rightDoubleArrow:809168332569575427> **[Ban New Members](https://mobilfan.gitbook.io/wickdocs-wip/v/main/commands/moderation/lockdown#4-auto-ban-new-members-b)** `w!ld ?t b`' },
            ...
            { name: '<:premium:809589966153711707> Premium', value: '<:blank:809168046052474881> <:rightDoubleArrow:809168332569575427> [**Roles**](https://mobilfan.gitbook.io/wickdocs-wip/v/main/commands/moderation/lockdown#5-roles-r) `w!lock ?t r` \n <:blank:809168046052474881> <:rightDoubleArrow:809168332569575427> [**All**](https://mobilfan.gitbook.io/wickdocs-wip/v/main/commands/moderation/lockdown#6-all-server-wide-s) `w!lock ?t all`' },
